...
?>
        <style>
            .gks-default-banner-box {
                ...
                background: linear-gradient(341deg, rgba(48,72,94,1) 0%, rgba(66,41,114,1) 35%, rgba(48,72,94,1) 100%);
                height: 100px;
                margin-bottom: 20px;
                color: white;
            }
        ...
        <div class="gks-default-banner-box">
            <div class="gks-default-banner-box--logo-block">
                ...
                <div class="gks-default-banner-box--logo-title"><?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_PREMIUM ? "WordPress Slider Plugin" : "FREE"; ?></div>
            </div>
