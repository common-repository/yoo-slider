...
var gks_action = "<?php echo esc_attr($gks_action) ?>";
...
var gks_slider = {};
gks_slider.id = "<?php echo esc_attr($gks_sid) ?>";
gks_slider.slides = {};
gks_slider.corder = [];
...
function gks_addSlideItem(gks_slide, type)
{
    ...
    html +=
        '<tr id="gks-gallery-slide-' + gks_slide.id + '" data-id="' + gks_slide.id + '" class="gks-gallery-slide">' +
            ...
            '<td class="gks-content">' +
                ...
                '<div class="gks-content-box ' + (type == gks_attachmentTypeHTML ? "gks-hidden" : "" )+ '"><input type="text" placeholder="CSS selector" name="slide.csssel" value=""></div>' +
    ...
    jQuery("input[name='slide.csssel']", html).val(gks_slide.csssel);
...
function gks_updateUI(){
    ...
    if(gks_slider.title){
        jQuery("#gks-slider-title").val( gks_slider.title );
    }
...
function gks_updateModel(){
    ...
    gks_slider.title = jQuery("#gks-slider-title").val();
    ...
    jQuery(".gks-gallery-slide").each(function(key, elem){
        ...
        gks_activeSlide.csssel = jQuery("input[name='slide.csssel']", elem).val();
