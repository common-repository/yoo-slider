...
<div id="gks-dashboard-wrapper">
    <div id="gks-dashboard-actionbar">
        <a href="<?php echo esc_url(GKSHelper::getPageUrl(GKSLayoutType::SLIDER, 'create')); ?>">
    ...
    <form id="" method="get">
        ...
        <input type="hidden" name="page" value="<?php echo esc_attr($gks_adminPage) ?>" />
        <input type="hidden" name="gks_nonce" value="<?php echo esc_attr(wp_create_nonce( 'gks_nonce' )) ?>" />
