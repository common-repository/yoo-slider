...
function gks_escTooltipForOption($option){
    $tooltip = "";
    $tooltip .= "<div class=\"gks-tooltip-content\">";
    $tooltip .=      "<img src=\"". esc_url(GKS_IMAGES_URL ."/general/glazzed-image-placeholder.png") . "\" />";
    $tooltip .= "</div>";
...
function gks_layoutWithName($name, $active = ''){
    ...
    $html .=            "<h3 class='gks-layout-title'>" . esc_attr(layoutDisplayName($layoutType)) . "</h3>";
    $html .=        "</div>";
    $html .=    "</a>";
    $html .= "</li>";
...
<div class="gks-options-header">
    <div class="gks-three-parts gks-fl">
        <a class='gks-back-btn button-secondary slider-button gks-glazzed-btn gks-glazzed-btn-dark' href="<?php echo esc_url("?page=" . $gks_adminPage); ?>">
            <div class='gks-icon gks-slider-button-icon'><i class="fa gks-fa fa-long-arrow-left"></i></div>
        </a>
    </div>

    <div class="gks-three-parts gks-fl gks-title-part gks-settings-title"><span>SETTINGS</span></div>

    <div class="gks-three-parts gks-fr">
        <a id="gks-save-options-button" class='button-secondary options-button gks-glazzed-btn gks-glazzed-btn-green slider-button' href="#">
            <div class='gks-icon gks-slider-button-icon'><i class="fa gks-fa fa-save fa-fw"></i></div>
        </a>
    </div>
</div>

<hr class="gks-options-top-hr" />

<?php
 if (isset($_GET["yoopreview"]) && (int)$_GET["yoopreview"] == 1) {
   echo '<style>body {position: fixed; overflow: invisible !import;} </style>';
   echo '<div id="gks-preview-bg" class="gks-preview-bg"></div>';
   echo '<div id="gks-preview" class="gks-preview">'. do_shortcode("[yooslider id={$gks_sid}]") . "</div>";
   die();
 }
?>

<div class="gks-preview-win-container">
  <div class="gks-preview-win-top">
    <span class="gks-preview-win-dot" style="background: #ED594A;"></span>
    <span class="gks-preview-win-dot" style="background:#FDD800;"></span>
    <span class="gks-preview-win-dot" style="background:#5AC05A;"></span>
  </div>

  <div class="gks-preview-win-content" >
    <iframe id="gks-preview-iframe" src="<?php echo esc_url($_SERVER['REQUEST_URI'] . '&yoopreview=1') ?>" width=100% height=600px; style="opacity: 0;"></iframe>

    <script>
      var frame = document.getElementById("gks-preview-iframe");
      frame.onload = function() {
        frame.style.opacity = 1;

        frame.style.height = frame.contentWindow.document.getElementById("gks-preview").offsetHeight + 'px';
      }

      setInterval(function(){
        var preview = frame.contentWindow.document.getElementById("gks-preview");
        if (preview != null) {
        ...
        <div class="body" style="display: block">
            <div class="gks-options-section">
                <ul class="gks-layouts">
                    <?php echo gks_layoutWithName('slider-general'); //Already escaped html ?>
                    <?php echo gks_layoutWithName('slider-carousel'); //Already escaped html ?>
                    <?php echo gks_layoutWithName('slider-scroller'); //Already escaped html ?>
                    <?php echo gks_layoutWithName('slider-coverflow'); //Already escaped html ?>
                </ul>
            </div>
        </div>
    </div>
              ...
              <br/>
                ...
                <div class="" style="">
                    <div class="gks-options-row">
                        ...
                        <input id="<?php echo esc_attr(GKSOption::kShowTitle) ?>" type="checkbox">
                        <i class="fa gks-fa fa-info-circle tooltip" title="<?php echo gks_escTooltipForOption('opname'); ?>"></i>
                    </div>
                    ...
                    <div class="gks-options-row">
                        <label>Show text button in details:</label>
                        <input id="<?php echo GKSOption::kShowTextButton ?>" type="checkbox" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'disabled' : '' ?> class="<?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-free' : '' ?>">
    ...
    <div class="collapse-card">
        ...
        <div class="body">
            <div class="gks-options-section">
                ...
                <div class="gks-options-row">
                    <label>Text button display style:</label>

                    <select id="<?php echo GKSOption::kTextButtonDisplayStyle ?>" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'disabled' : '' ?> class="<?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-free' : '' ?>">
                        <option value="<?php echo GKSTextButtonDisplayStyle::Bordered ?>" selected="selected">Bordered</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::Minimal ?>">Minimal</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::Stretch ?>">Stretch</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::Jelly ?>">Jelly</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::MaterialCircle ?>">Material Circle</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::MaterialFlat ?>">Material Flat</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::Pill ?>">Pill</option>
                        <option value="<?php echo GKSTextButtonDisplayStyle::Slant ?>">Slant</option>
                    </select>
                    <?php if(GKS_PKG_TYPE == GKS_PKG_TYPE_FREE): ?><div class='gks-premium-option-badge'>PREMIUM</div><?php endif; ?>
                ...
                <div class="gks-options-row">
                    ...
                    <select id="<?php echo GKSOption::kButtonIcon ?>">
                        <?php echo gks_inflateButtonFontawosomeIconOptions(); //Hardcoded/escaped html ?>
                    </select>
                </div>
    ...
    <div class="collapse-card">
        ...
        <div class="body">
            <div class="gks-options-section">
                ...
                <div class="gks-options-row fh">
                    <label>Slide button background color:</label>
                ...
                <div class="gks-options-row gks-binding" data-binding="<?php echo GKSOption::kTextButtonTextColor ?>">
                  <hr/>
                </div>

                <div class="gks-options-row <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-disabled-color-picker' : '' ?> fh">
                    <label>Slide text button color:</label>
                    <input id="<?php echo GKSOption::kTextButtonTextColor ?>" type="text" class="gks-color-picker">
                    <?php if(GKS_PKG_TYPE == GKS_PKG_TYPE_FREE): ?><div class='gks-premium-option-badge gks-premium-color-badge'>PREMIUM</div><?php endif; ?>
                    <i class="fa gks-fa fa-info-circle tooltip" title="<?php echo gks_escTooltipForOption('opname'); ?>"></i>
                </div>

                <div class="gks-options-row <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-disabled-color-picker' : '' ?> fh">
                    <label>Slide text button bg color:</label>
                    <input id="<?php echo GKSOption::kTextButtonBgColor ?>" type="text" class="gks-color-picker">
                    <?php if(GKS_PKG_TYPE == GKS_PKG_TYPE_FREE): ?><div class='gks-premium-option-badge gks-premium-color-badge'>PREMIUM</div><?php endif; ?>
                    <i class="fa gks-fa fa-info-circle tooltip" title="<?php echo gks_escTooltipForOption('opname'); ?>"></i>
                </div>
        ...
        <div class="body">
            <div class="gks-options-section">
              <br/>
                ...
                <div class="gks-options-row fh">
                    <label>Aspect ratio (h = w * r):</label>
                ...
                <div class="gks-options-row fh">
                    <label>Slider content paddings:</label>
                    <input id="<?php echo GKSOption::kSliderPadding?>" class="only-digits" type="text">
    ...
    <div class="collapse-card">
        ...
        <div class="body">
            <div class="gks-options-section">
              ...
              <div class="gks-options-row gks-binding" data-binding="<?php echo GKSOption::kTextButtonAlignment ?>">
                <hr/>
              </div>

              <div class="gks-options-row">
                  <label>Text button alignment:</label>
                  <select id="<?php echo GKSOption::kTextButtonAlignment ?>" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'disabled' : '' ?> class="<?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-free' : '' ?>">
                      <option value="flex-start" selected="true">Left</option>
              ...
              <div class="gks-options-row">
                  <label>Text button font style:</label>
                  <select id="<?php echo GKSOption::kTextButtonFontStyle ?>" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'disabled' : '' ?> class="<?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-free' : '' ?>">
                      <option value="normal" selected="true">Normal</option>
                      <option value="bold">Bold</option>
                      <option value="italic">Italic</option>
                  </select>
              ...
              <div class="gks-options-row fh">
                  <label>Text button font size:</label>
                  <input id="<?php echo GKSOption::kTextButtonFontSize?>" class="only-digits <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-free' : '' ?>" type="text" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'disabled' : '' ?>>
                  <select class="unit" disabled="disabled">
                      <option value="px" selected="true">px</option>
                  </select>
                  <?php if(GKS_PKG_TYPE == GKS_PKG_TYPE_FREE): ?><div class='gks-premium-option-badge'>PREMIUM</div><?php endif; ?>
        ...
        <div class="body">
            <div class="gks-options-section gks-social-networks">
              ...
              <br/>
                ...
                <div class="gks-options-row fh">
                    <label>Text button title:</label>
                    <input id="<?php echo GKSOption::kTextButtonTitle?>" class=" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'gks-free' : '' ?>" type="text" <?php echo GKS_PKG_TYPE == GKS_PKG_TYPE_FREE ? 'disabled' : '' ?> >
                    <?php if(GKS_PKG_TYPE == GKS_PKG_TYPE_FREE): ?><div class='gks-premium-option-badge'>PREMIUM</div><?php endif; ?>
                    <i class="fa gks-fa fa-info-circle tooltip" title="<?php echo gks_escTooltipForOption('opname'); ?>"></i>
                </div>
...
<?php if (GKS_PKG_TYPE == GKS_PKG_TYPE_PREMIUM) { ?>
  <div id="gks-scroller-options-accordion" class="gks-options-wrapper gks-slider-options-wrapper">
    <h3 class="gks-section-title">SCROLLER OPTIONS</h3>
...
<?php if (GKS_PKG_TYPE == GKS_PKG_TYPE_PREMIUM) { ?>
  <div id="gks-popup-options-accordion" class="gks-options-wrapper gks-slider-options-wrapper">
    <h3 class="gks-section-title">POPUP OPTIONS</h3>
...
<script>
    ...
    var gks_adminPage = "<?php echo esc_attr($gks_adminPage) ?>";
    var gks_sid = "<?php echo esc_attr($gks_sid) ?>";

    gks_options = {};

    var gks_isColorpickerOpened = false;
    jQuery(document).ready(function() {
        ...
        jQuery(function() {
            ...
            // As we do not have a callback, we simulate when the colorpicker is closed
            jQuery(".gks-options-section .button").on("click", function(){
                gks_isColorpickerOpened = !gks_isColorpickerOpened;

                if (!gks_isColorpickerOpened) {
                  triggerAutosave();
                }
            })

            jQuery(".gks-wrap").on("click", function(){
                if (gks_isColorpickerOpened) {
                  gks_isColorpickerOpened = false;
                  triggerAutosave();
                }
            })
        });
        ...
        //Trigger autosave on any changes
        gks_initiateAutosaveBindings();
    ...
    function gks_updateUITextbox(options){
        for(var i in options) {
            jQuery('#'+options[i]).val( gks_options[options[i]]);
        }
    }

    function gks_fixDefaults() {
      if(jQuery('#kScrollerHeight').val() == "") {

        jQuery('#kScrollerShowCover').attr('checked', 1 );
        setOptionSelectedFor('#kScrollerPosition', 'before');
        jQuery('#kScrollerHeight').val( 70);
        jQuery('#kScrollerLgDesktopCols').val( 6);
        jQuery('#kScrollerDesktopCols').val( 5);
        jQuery('#kScrollerTabletCols').val( 4);
        jQuery('#kScrollerMobileCols').val( 3);
      }
    }
    ...
    function gks_getCheckboxOptions()
    {
        return [
            ...
            '<?php echo GKSOption::kShowTextButton; ?>',
    ...
    function gks_getSelectboxOptions()
    {
        return [
            ...
            '<?php echo GKSOption::kTextButtonFontStyle; ?>',
            ...
            '<?php echo GKSOption::kTextButtonAlignment ?>',
            '<?php echo GKSOption::kInfoDisplayStyle ?>',
            '<?php echo GKSOption::kTextButtonDisplayStyle ?>',
    ...
    function getTextboxOptions()
    {
        return [
            ...
            '<?php echo GKSOption::kTextButtonTextColor; ?>',
            '<?php echo GKSOption::kTextButtonBgColor; ?>',
        ];
    }
    ...
    function gks_updateModelTextbox(options)
    {
        for(var i in options) {
            gks_options[options[i]] = selectedOptionsFor('#'+[options[i]]);
            gks_options[options[i]] = jQuery('#'+options[i]).val();
        }
    }
    ...
    function gks_configureSliderLayout()
    {
        ...
        if (jQuery('.gks-layout-type-option.active').attr('id') == "<?php echo GKSViewType::SliderCarousel ?>") {
            ...
            if (!jQuery("#<?php echo GKSOption::kSliderPaginationPosition ?> option:selected").hasClass('carousel')) {
                jQuery("#<?php echo GKSOption::kSliderPaginationPosition ?>").val(jQuery("#<?php echo GKSOption::kSliderPaginationPosition ?> option.carousel").first().val());
            }
            ...
            if (typeof gks_options.carouselUsed == 'undefined') {
                ...
                gks_setDefaultForInput("<?php echo GKSOption::kSliderPadding ?>", 0, false);
                ...
                gks_setDefaultForInput("<?php echo GKSOption::kTextButtonTextColor ?>", '#000000', true);
                gks_setDefaultForInput("<?php echo GKSOption::kTextButtonBgColor ?>", '#000000', true);
            ...
            if (!jQuery("#<?php echo GKSOption::kSliderPaginationPosition ?> option:selected").hasClass('no-carousel')) {
                jQuery("#<?php echo GKSOption::kSliderPaginationPosition ?>").val(jQuery("#<?php echo GKSOption::kSliderPaginationPosition ?> option.no-carousel").first().val());
            }
        }
    ...
    function gks_bindCheckboxToAutosave(options)
    {
        for(var i in options) {
            jQuery('#'+options[i]).change(function(){
              triggerAutosave();
            });
        }
    }

    function gks_bindSelectboxToAutosave(options)
    {
        for(var i in options) {
            jQuery('#'+options[i]).change(function(){
              triggerAutosave();
    ...
    function gks_bindTextboxToAutosave(options)
    {
        for(var i in options) {
            jQuery('#'+options[i]).change(function(){
              triggerAutosave();
    ...
    function gks_initiateAutosaveBindings() {
      gks_bindCheckboxToAutosave(gks_getCheckboxOptions());
      gks_bindCheckboxToAutosave(gks_getSelectboxOptions());
      gks_bindTextboxToAutosave(getTextboxOptions());
    }

    function triggerAutosave() {
      jQuery("#gks-save-options-button").click();
    }
