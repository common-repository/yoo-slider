...
define( 'GKS_API_DOMAIN', 'yooslider.com' );
...
define( 'GKS_SAMPLE_IMG_NAME', 'yoo_sample_img.jpg' );
...
define("GKS_LICENSE_TYPE", "lifetime");
...
abstract class GKSOption{
    ...
    const kTextButtonTitle = "kTextButtonTitle";
    ...
    const kShowTextButton = "kShowTextButton";
    const kAppearButtonOnHover = "kAppearButtonOnHover";
    const kInfoDisplayStyle = "kInfoDisplayStyle";
    const kTextButtonDisplayStyle = "kTextButtonDisplayStyle";
    ...
    const kTextButtonTextColor = "kTextButtonTextColor";
    const kTextButtonBgColor = "kTextButtonBgColor";
    const kSliderPadding = "kSliderPadding";
...
abstract class GKSTextButtonDisplayStyle{
    const Bordered = 'bordered';
    const Minimal = 'minimal';
    const Stretch = 'stretch';
    const Jelly = 'jelly';
    const Fill = 'fill';
    const MaterialCircle = 'material-circle';
    const MaterialFlat = 'material-flat';
    const Pill = 'pill';
    const Sail = 'float';
    const Unite = 'unite';
    const Slant = 'slant';
...
define( 'GKS_ALLOWED_HTML_TAG_ATTRS',
  array(
    'style' => array(),
    'class' => array(),
  )
...
define( 'GKS_ALLOWED_HTML_A_TAG_ATTRS',
  array(
    'style' => array(),
    'class' => array(),
    'href' => array(),
...
define( 'GKS_ALLOWED_HTML_IMG_TAG_ATTRS',
  array(
    'style' => array(),
    'class' => array(),
    'src' => array(),
...
define( 'GKS_ALLOWED_HTML',
  array(
      'h1' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h2' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h3' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h4' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h5' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h6' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'p' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'div' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'span' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'a' => GKS_ALLOWED_HTML_A_TAG_ATTRS,
      'hr' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'br' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'em' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'i' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'strong' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'u' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'ul' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'ol' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'li' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'table' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'tr' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'td' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'th' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'img' => GKS_ALLOWED_HTML_IMG_TAG_ATTRS,
    )
);

define( 'GKS_ALLOWED_BANNER_HTML',
  array(
      'h1' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h2' => GKS_ALLOWED_HTML_TAG_ATTRS,
      'h3' => GKS_ALLOWED_HTML_TAG_ATTRS,
