...
class GKSHelper {
    ...
    static public function getSliderIdentifiers(){
        global $wpdb;
        $sliders = array();

        $query = "SELECT id FROM ".GKS_TABLE_SLIDERS;
    ...
    static public function getDefaultOptions($sid = 0, $layoutType = GKSLayoutType::SLIDER){
        ...
        $options = '{"id":"' . $sid . '","kShowPopupOnClick":false,"kHeightCalcAlgo":"Fixed","kThumbnailQuality":"large","kScrollerShowTitle":false,"kScrollerShowCover":true,"kScrollerShowBorder":true,"kShowTitle":true,"kShowDetails":true,"kShowArrows":true,"kShowInfoMobile":"true","kShowPagination":true,"kShowPaginationMobile":true,"kEnableGridLazyLoad":false,"kLoadUrlBlank":false,"kTileOverlayOpacity":"A6","kTileTitleFont":"","kFont":"","kTileTitleFontStyle":"bold","kFontStyle":"normal","kTextButtonFontStyle":"normal","kTileTitleAlignment":"center","kTileDescAlignment":"center","kTextButtonAlignment":"center","kPaginationColor":"#b1b0b0","kPaginationHoverColor":"#000000","kTileTitleColor":"#ffffff","kTileDescColor":"#ffffff","kTileOverlayColor":"#000000","kCustomJS":"","kCustomCSS":"","kSliderHeight":"450",'.$colCalcAlgo.',"kSliderPadding": "0", "kTileMargins": "0", "kTilePaddings": "20","kSliderArrowsPadding": "20","kSliderInfoPadding": "20","kTileTitleFontSize":"18","kFontSize":"13","kTextButtonFontSize":"13","kArrowFontSize":"60","kSliderAutoplay":false,"kSliderAutoHeight":false,"kImageBackgroundSize":"cover","kImageBackgroundPosition":"center","kSliderLoop":false,"kSliderPauseOnHover":false,"kArrowIconStyle":"fa-angle-","kSliderPaginationStyle":"Dots","kSliderPaginationPosition":"AfterSlider","kSliderTextWidthStyle":"Auto","kArrowBgStyle":"None","kArrowPosition":"Center","kSlideAnimation":"","kSliderTextPosition":"BottomCenter","kArrowBgColor":"#000000","kArrowBgHoverColor":"#000000","kArrowBgOpacity":"A6","kArrowBgHoverOpacity":"BF","kScrollerThumbBgColor":"#555555","kScrollerActiveThumbBgColor":"#aaaaaa","kScrollerThumbBorderColor":"#cc0000","kScrollerActiveThumbBorderColor":"#333333", "kScrollerThumbTitleColor":"#ffffff","kArrowColor":"#e2e2e2","kArrowHoverColor":"#ffffff","kSliderAutoplaySpeed":"5", "kTextButtonTitle":"READ MORE","kViewType":"1","kScrollerHeight":"70","kScrollerPosition":"after","kTextButtonDisplayStyle":"bordered","kTextButtonTextColor":"#000","kTextButtonBgColor":"#000"}';
    ...
    static function getSampleImage()
    {
        ...
        if (empty($upload_id)) {
            ...
            $fname = sanitize_file_name(GKS_SAMPLE_IMG_NAME);
            $fpath = GKS_SAMPLE_IMG_PATH;
            $new_file_path = $wordpress_upload_dir['path'] . '/' . $fname;
            $new_file_mime = sanitize_mime_type( mime_content_type( $fpath ) );
            $i = 1;
    ...
    static function saveMediaImage($remoteUrl)
    {
      $image = $remoteUrl;
      ...
      $attachment = array(
          ...
          'post_mime_type' => sanitize_mime_type($type)
      );

      $foundMediaId = GKSHelper::findMediaWithName($attachment['post_title']);
      if ($foundMediaId) {
        return $foundMediaId;
      }
    ...
    static function findMediaWithName($filename) {
      global $wpdb;

      $sql = $wpdb->prepare("SELECT * FROM `". $wpdb->postmeta ."` WHERE `meta_value` LIKE %s LIMIT 1", array("%" . $filename . "%"));
